...
wrong with the post which prompted me to create a post of my own with those 
fixes.

### As of Dec 27, 2023, the blog has fixed the incorrect listed pins.
***
## Providing Context
...
Within this guide, it mentioned about bypassing The Tsunami through using a **pencil**
...
cause a user to destroy their Chromebook. *Yes, there are people in this community, many in fact,
...
I decided that I was gonna make my own blog with a post (like this one) which provided correct
instructions, however I had gotten lazy and schoolwork was piling up, so I couldn't till now.
...
- Competent and courage, because I don't recommend this.
...
Enter the Utilities screen and run "Un-Enroll Device" (or "Deprovision Device" if Legacy). This won't do anything, but it's a necessary step. After that, enter the Bash Shell and then run the following commands. It should end up like the
picture below:
...
<figure>
    <img 
        ...
        alt="Command Output" 
    />
    <figcaption style="text-align: center">Command Output</figcaption>
</figure>
...
There have already been reports of people bricking their Chromebook in servers like the SH1MMER Discord or the 
TitaniumNetwork Discord. These are because of bridging incorrect pins, bridging multiple pins, or many other reasons.
...
For me, I have OCTOPUS and JACUZZI Chrombooks where I can downgrade to any version anytime I want cause I used 
[this guide](https://osu.bio/sh1mmer/unfog), so I don't need this. 
