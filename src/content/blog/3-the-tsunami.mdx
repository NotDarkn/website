...
**As of Feb 20, 2025:** Ti50 devices (nissa, corsola, dedede) are **HEAVILY DISCOURAGED FROM FOLLOWING THIS GUIDE**. Please follow [this guide](https://github.com/truekas/PencilSharpener/blob/main/README.md) instead. If you have none of the prior listed devices, you may proceed with this guide.
