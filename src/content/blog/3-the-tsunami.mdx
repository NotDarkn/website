...
If the command succeeds (as stated by the `SUCCESS`), then you may turn off the Chromebook, unplug the power source,
and then remove the bridge. **This is highly recommended to prevent any accidental damage.**
<figure>
    <img 
